                        ...
                        children: [
                              ...
                              child: StreamBuilder<List<HospitalsRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<HospitalsRecord>
                                      ...
                                      snapshot.data!;
                                  if (listViewHospitalsRecordList.isEmpty) {
                                    return Center(
                                      child: Image.asset(
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount:
                                        listViewHospitalsRecordList.length,
                                                        ...
                                                        image:
                                                          ...
                                                          imageUrl:
                                                            ...
                                                            listViewHospitalsRecord
                                                                .picture,
                                                            'https://img.freepik.com/free-vector/people-walking-sitting-hospital-building-city-clinic-glass-exterior-flat-vector-illustration-medical-help-emergency-architecture-healthcare-concept_74855-10130.jpg?w=1060&t=st=1679471797~exp=1679472397~hmac=dfaccfb4bd1e82aa9b0ce924f68061d88073d1247b365aa25e49859d91a042e0',
                                                          ),
                                                          fit: BoxFit.contain,
                                                        ),
                                                        allowRotation: false,
                          ...
                          Container(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 8.0, 0.0, 0.0),
                              child: StreamBuilder<List<ClosedhospitalsRecord>>(
                                stream: queryClosedhospitalsRecord(),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                                  ...
                                  List<ClosedhospitalsRecord>
                                      listViewClosedhospitalsRecordList =
                                      snapshot.data!;
                                  if (listViewClosedhospitalsRecordList
                                      .isEmpty) {
                                    return Center(
                                      child: Image.asset(
                                  ...
                                  return ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    scrollDirection: Axis.vertical,
                                    itemCount: listViewClosedhospitalsRecordList
                                        .length,
                                    itemBuilder: (context, listViewIndex) {
                                      final listViewClosedhospitalsRecord =
                                          listViewClosedhospitalsRecordList[
                                              listViewIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'MY_TRIPS_PAGE_Image_sqctxmki_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Image_expand_image');
                                                  await Navigator.push(
                                                    context,
