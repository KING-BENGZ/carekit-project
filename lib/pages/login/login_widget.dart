      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            ...
            image: Image.asset(
              'assets/images/top-view-health-still-life-arrangement-with-copy-space.jpg',
            ).image,
          ),
        ),
        child: Column(
                        ...
                        child: Row(
                          ...
                          children: [
                            if (!(Theme.of(context).brightness ==
                                Brightness.dark))
                              Image.asset(
                                'assets/images/2048-Recovered.png',
                                width: 200.0,
                                height: 60.0,
                                fit: BoxFit.fitWidth,
                              ),
                            if (Theme.of(context).brightness == Brightness.dark)
                              Image.asset(
                                'assets/images/2048-Recovered_n.png',
                                width: 200.0,
                                height: 60.0,
                                fit: BoxFit.fitWidth,
                              ),
